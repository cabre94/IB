...
def graficos_6():
    path_data  = os.path.join("Informe","Datos","6","lr=1.0e-03_rf=1.0e-01_do=0_epochs=500_bs=32_nn=20_ed=100.npy")
...
def graficos_6_40N():
    path_data  = os.path.join("Informe","Datos","6","lr=1.0e-03_rf=1.0e-01_do=0_epochs=500_bs=32_nn=40_ed=100.npy")
...
def graficos_6_CCorreccion():
    path_data  = os.path.join("Informe","Datos","6_Correccion","lr=1.0e-03_rf=1.0e-01_do=0_epochs=500_bs=32_nn=40_ed=100.npy")
...
def graficos_7():
    path_data  = os.path.join("Informe","Datos","7","lr=1.0e-05_rf=0.0e+00_do=0_epochs=500_bs=256_nn=10_ed=100.npy")
    path_model  = os.path.join("Informe","Datos","7","lr=1.0e-05_rf=0.0e+00_do=0_epochs=500_bs=256_nn=10_ed=100.h5")
...
def graficos_7_v2():
    path_data  = os.path.join("Informe","Datos","7_Internet","MSE_lr=1.0e-05_rf=0.0e+00_do=0_epochs=1000_bs=512_nn=10_ed=100.npy")
    path_model  = os.path.join("Informe","Datos","7_Internet","MSE_lr=1.0e-05_rf=0.0e+00_do=0_epochs=1000_bs=512_nn=10_ed=100.h5")
...
def graficos_8_Densa():
    path_data  = os.path.join("Informe","Datos","8_Dense","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.npy")
    path_model  = os.path.join("Informe","Datos","8_Dense","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.h5")
...
def graficos_8_Conv():
    path_data  = os.path.join("Informe","Datos","8_Conv","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.npy")
    path_model  = os.path.join("Informe","Datos","8_Conv","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.h5")
...
def graficos_9_Densa():
    path_data  = os.path.join("Informe","Datos","9_Dense","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.npy")
    path_model  = os.path.join("Informe","Datos","9_Dense","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.h5")
...
def graficos_9_Conv():
    path_data  = os.path.join("Informe","Datos","9_Conv","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.npy")
    path_model  = os.path.join("Informe","Datos","9_Conv","lr=1.0e-04_rf=1.0e-03_do=0.4_epochs=200_bs=512_nn=10_ed=100.h5")
...
def graficos_10_AlexNet_Cifar10():
    path_data  = os.path.join("Informe","Datos","10_AlexNet_cifar10","lr=1.0e-03_rf=1.0e-03_do=0_epochs=100_bs=64_nn=10_ed=100.npy")
...
def graficos_10_AlexNet_Cifar100():
    path_data  = os.path.join("Informe","Datos","10_AlexNet_cifar100","1.0e-03_3.0e-04_100_64_SINDROP.npy")
...
def graficos_10_VGG_Cifar10():
    path_data  = os.path.join("Informe","Datos","10_VGG16_cifar10","1.0e-03_6.0e-04_50_256_SINDROP.npy")
...
def graficos_10_VGG_Cifar100():
    path_data  = os.path.join("Informe","Datos","10_VGG16_cifar100","1.0e-03_6.0e-04_100_256_SINDROP.npy")
