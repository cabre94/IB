...
public:
	...
	Polinomio integrate(double c);	// crea y retorna el polinomio integrado con constante 'c'
...
Polinomio &Polinomio::operator=(const Polinomio &p){	// a = b como a.operator=(b)
...
Polinomio Polinomio::derivate(){	// Esto no se si esta bien
	...
	// Creo que me falto borrar coefs_der
	delete [] coefs_der;
	return res;
}
